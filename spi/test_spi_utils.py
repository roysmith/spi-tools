...
class CacheableSpiCaseTest(TestCase):
    ...
    @patch('spi.spi_utils.cache')
    def test_cache_is_called_if_use_cache_is_default(self, cache):
        wiki = NonCallableMock(Wiki)
        wiki.page().revisions.side_effect = [
            [WikiContrib(2020_07_29, datetime(2020, 7, 29), 'user1', 4, 'Wikipedia:Sockpuppet investigations/Fred', '')],
            [],
    ...
    @patch('spi.spi_utils.cache')
    def test_cache_is_called_if_use_cache_is_true(self, cache):
        wiki = NonCallableMock(Wiki)
        wiki.page().revisions.side_effect = [
            [WikiContrib(2020_07_29, datetime(2020, 7, 29), 'user1', 4, 'Wikipedia:Sockpuppet investigations/Fred', '')],
            [],
        ...
        case = CacheableSpiCase.get(wiki, 'Fred', use_cache=True)
    ...
    @patch('spi.spi_utils.cache')
    def test_cache_is_called_if_use_cache_is_false(self, cache):
        wiki = NonCallableMock(Wiki)
        wiki.page().revisions.side_effect = [
            [WikiContrib(2020_07_29, datetime(2020, 7, 29), 'user1', 4, 'Wikipedia:Sockpuppet investigations/Fred', '')],
            [],
        ...
        case = CacheableSpiCase.get(wiki, 'Fred', use_cache=False)
